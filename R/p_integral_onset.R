...
#'
#' @export
p_integral_onset <- function(incubation_period, date_lower, date_upper, exposure, exposure_weight = NULL) {

  fct <- function(x) p_new_onset(incubation_period, x, exposure, exposure_weight)
