...
__`p_new_onset()`__ Computes the probability of new symptoms on a particular day for a particular contact

__`p_integral_onset()`__ Computes the probability of new symptoms within a range of dates for a particular contact, given the incubation period.
