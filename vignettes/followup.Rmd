...
__`to_html()`__ Helper function print contact list as html table.
...
to_html(contact_list, date_cols = list("dates_exposure", "exposure_end", "date_last_followup"))
```
...
to_html(contact_list_2, date_cols = list("dates_exposure", "date_last_followup"))
```
...
to_html(contact_list_p3, cols_round = list("p_onset", "p_symptoms"), date_cols = list("dates_exposure", "date_last_followup"))
```
...
```{r, echo = TRUE}
contact_list_p4 <- followup_priorities(
                      contact_list,
                      exposure = dates_exposure,
                      exposure_end = exposure_end,
                      last_followup = date_last_followup,
...
to_html(contact_list_p4, cols_round = list("p_disease", "p_onset", "p_symptoms"), date_cols = list("dates_exposure", "date_last_followup"))
```
